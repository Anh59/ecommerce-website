            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 ">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_feature">
                                <div class="single_feature_part">
                                    <img src="<?= base_url('aranoz-master/img/icon/feature_icon_1.png'); ?>" alt="">
                                    <h4>A Volunteer</h4>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_feature">
                                <div class="single_feature_part">
                                    <img src="<?= base_url('aranoz-master/img/icon/feature_icon_2.png'); ?>" alt="">
                                    <h4>A Volunteer</h4>
                                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor</p>
                                </div>
                            </div>
                            <div class="single_feature">
                                <div class="single_feature_part single_feature_part_2">
                                    <img src="<?= base_url('aranoz-master/img/icon/feature_icon_3.png'); ?>" alt="">
                                    <h4>A Volunteer</h4>
                                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor</p>
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="feature_part_text">
                        ...
                        <a href="#" class="btn_4">learn more <img src="<?= base_url('aranoz-master/img/icon/right-arrow.svg'); ?>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>

        <img src="<?= base_url('aranoz-master/img/animate_icon/Shape-1.png'); ?>" alt="" class="feature_icon_1">
        <img src="<?= base_url('aranoz-master/img/animate_icon/Shape-14.png'); ?>" alt="" class="feature_icon_2">
        <img src="<?= base_url('aranoz-master/img/animate_icon/Shape.png'); ?>" alt="" class="feature_icon_3">
        <img src="<?= base_url('aranoz-master/img/animate_icon/shape-3.png'); ?>" alt="" class="feature_icon_4">
    </section>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="learning_img">
                        <img src="<?= base_url('aranoz-master/img/about_img.png'); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
        <img src="<?= base_url('aranoz-master/img/left_sharp.png'); ?>" alt="" class="left_shape_1">
        <img src="<?= base_url('aranoz-master/img/about_shape.png'); ?>" alt="" class="about_shape_1">
        <img src="<?= base_url('aranoz-master/img/animate_icon/Shape-16.png'); ?>" alt="" class="feature_icon_1">
        <img src="<?= base_url('aranoz-master/img/animate_icon/Shape-1.png'); ?>" alt="" class="feature_icon_4">
    </section>
    <!-- about_us part end-->
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        <a href="index.html" class="footer_logo_iner"> <img src="<?= base_url('aranoz-master/img/footer_logo.png'); ?>" alt="#"> </a>
                        <h4>About Us</h4>
