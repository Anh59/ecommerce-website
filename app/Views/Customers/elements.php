	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				...
				<div class="row">
					<div class="col-md-3">
						<img src="<?= base_url('aranoz-master/img/elements/d.jpg'); ?>" alt="" class="img-fluid">
					</div>
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f1.jpg'); ?>" alt="flag">Canada</div>
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f2.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f3.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f4.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f5.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f6.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f7.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="<?= base_url('aranoz-master/img/elements/f8.jpg'); ?>" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
			...
			<div class="section-top-border">
				...
				<div class="row gallery-item">
					<div class="col-md-4">
						<a href="<?= base_url('aranoz-master/img/\1') ?>" class="img-pop-up img-gal">
