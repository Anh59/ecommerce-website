            ...
            <div class="col-lg-6">
              <div class="comment_list">
                <div class="review_item">
                  <div class="media">
                    <div class="d-flex">
                      <img src="<?= base_url('aranoz-master/img/product/single-product/review-1.png'); ?>" alt="" />
                    </div>
                ...
                <div class="review_item reply">
                  <div class="media">
                    <div class="d-flex">
                      <img src="<?= base_url('aranoz-master/img/product/single-product/review-2.png'); ?>" alt="" />
                    </div>
                    <div class="media-body">
                      <h4>Blake Ruiz</h4>
                      <h5>12th Feb, 2017 at 05:56 pm</h5>
                ...
                <div class="review_item">
                  <div class="media">
                    <div class="d-flex">
                      <img src="<?= base_url('aranoz-master/img/product/single-product/review-3.png'); ?>" alt="" />
                    </div>
                    <div class="media-body">
                      <h4>Blake Ruiz</h4>
                      <h5>12th Feb, 2017 at 05:56 pm</h5>
...
<?= $this->section('scripts') ?>
  ...
  <script src="<?= base_url('aranoz-master/js/swiper.jquery.js'); ?>"></script>
  ...
  <!-- custom js -->
  <script src="<?= base_url('aranoz-master/js/theme.js'); ?>"></script>
