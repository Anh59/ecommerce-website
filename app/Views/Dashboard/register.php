            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="register" method="post">
                        ...
                        <form onsubmit="return checkPasswordsMatch()">
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                <div class="input-group-text" style="cursor:pointer;" 
                                    onclick="let p=document.getElementById('retype_password'); p.type = p.type==='password'?'text':'password';">
                                    <span class="fas fa-eye"></span>
                                </div>
                                </div>
                            </div>

                            <div id="password-error" style="color:red; font-size:14px; display:none;">
                    ...
                    <a href="<?= route_to('adminlogin') ?>" class="text-center">I already have a membership</a>
                </div>
            </div>
        </div>
